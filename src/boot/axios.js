...
if (Platform.is.cordova) {
  window.axios.defaults.headers.common['Requested-From'] = 'mobile'
}
...
if (Platform.within.iframe) {
  window.axios.defaults.headers.common['Requested-From'] = 'iframe'
}

if (Platform.is.desktop) {
  window.axios.defaults.headers.common['Requested-From'] = 'desktop-web'
}
