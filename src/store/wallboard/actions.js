  ...
  async fetchSummary ({ commit, state }) {
    try {
      ...
      commit('SET_SUMMARY', {
        ...
        appointmentsSet: summary.appointments || 0,
        averageTalkTime: summary.average_talk_time,
        averageWaitTime: summary.average_wait_time,
        emailsReceived: summary.emails_received || 0,
        emailsSent: summary.emails_sent || 0,
        faxesReceived: summary.faxes_received || 0,
        faxesSent: summary.faxes_sent || 0,
        missedCalls: summary.missed_calls,
        remindersSet: summary.reminders || 0,
