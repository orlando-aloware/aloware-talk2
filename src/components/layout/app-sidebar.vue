...
export default {
  ...
  methods: {
    isActive (name) {
      ...
      if (['Inbox Contact', 'Inbox Channel', 'Inbox Contact Task', 'Inbox Channel Task Status', 'Inbox Contact Communication', 'Inbox View'].includes(this.$route.name) && name === 'Inbox') {
        return true
      }
