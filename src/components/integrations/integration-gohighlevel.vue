<template>
  <div
    ...
    data-testid="integration-gohighlevel-wrapper"
  >
    <q-card
    ...
    >
      ...
      <q-card-section
        ...
        data-testid="integration-gohighlevel-card-section-1"
      >
        <a
        ...
        <b-row>
          ...
          >
            ...
            >
              ...
              <p class="mt-0 mb-0">- You notice any inconsistencies between {{ whiteLabelName }} and HighLevel data on
                this contact.</p>
            </q-tooltip>
          </b-button>
        </b-row>
