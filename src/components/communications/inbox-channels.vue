...
export default {
  ...
  created () {
    ...
    this.listeners.communicationsLoadCommunications = (showMyContacts) => {
    ...
    this.$VueEvent.listen('communications_load_communications', this.listeners.communicationsLoadCommunications)
  },
