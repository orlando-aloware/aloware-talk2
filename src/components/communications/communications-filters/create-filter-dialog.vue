<template>
  <b-modal size="md"
           ...
           hide-header
           hide-footer
           data-testid="create-filter-dialog-modal"
           ...
           @hide="onHide"
           @hidden="onHidden">
    <b-form data-testid="create-filter-dialog-form"
            @submit.prevent="onSubmit">
      <b-form-row data-testid="create-filter-dialog-form-row">
        <b-col sm="12"
               md="12"
               class="mb-3"
               data-testid="create-filter-dialog-form-col">
        ...
        <b-col sm="12"
          ...
          <b-form-group label="Filter Name"
            ...
            <b-form-input size="md"
                          type="text"
                          placeholder="Name"
                          data-testid="create-filter-dialog-form-input-name"
                          :state="validateState('name')"
                          ref="filterNameInput"
                          v-model.trim="$v.filter.name.$model" />
            <b-form-invalid-feedback v-if="!$v.filter.name.required">
              Enter filter name
        ...
        <b-col sm="12"
          ...
          <b-button class="bg-grey-70 text-black border-0"
                    block
                    data-testid="create-filter-dialog-form-cancel-btn"
                    @click="onCancel">
            Cancel
          </b-button>
        </b-col>
        <b-col sm="12"
          ...
          <b-button type="submit"
                    variant="primary"
                    block
                    data-testid="create-filter-dialog-form-create-btn"
                    :disabled="isCreating">
...
export default {
  ...
  methods: {
    ...
    onSubmit () {
      ...
      const filterType = this.filterModel.type === ChannelType.CHANNEL_RECORDINGS
