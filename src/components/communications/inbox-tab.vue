...
export default {
  ...
  methods: {
    ...
    startInboxListeners () {
      ...
      this.$VueEvent.listen('communications_load_contacts', this.listeners.communicationsLoadContacts)
    ...
    stopInboxListeners () {
      ...
      this.$VueEvent.stop('communications_load_contacts', this.listeners.communicationsLoadContacts)
  ...
  mounted () {
    ...
    this.listeners.communicationsLoadContacts = debounce((showMyContacts, showUnreads) => {
      if (!this.isLoaded) {
        return
      }
