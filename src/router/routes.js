...
const HubSpotSoftPhone = () => import('pages/widgets/hubspot/HubSpotSoftPhone2.vue')
...
const routes = [
  {
    ...
    children: [
      ...
      {
        name: 'Salesforce Widget Error',
        path: '/errors/salesforce',
        props: true,
        meta: {
          isWidget: true
        },
        component: SalesforceMessageWidgetError
      }
    ]
  },
