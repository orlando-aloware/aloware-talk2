  ...
  methods: {
    ...
    logout () {
      this.logoutUser().then((res) => {
        ...
        /* eslint-disable */console.log(...oo_oo(`106194178_248_8_248_24_4`,err))
      })
    },
    ...
    fullStoryIdentify (profile) {
      ...
      window.axios.get('/fullstory-meta').then(({ data }) => {
        ...
        /* eslint-disable */console.log(...oo_oo(`106194178_264_8_264_100_4`,'Error while retrieving fullstory metadata from server. Using local variables.'))
