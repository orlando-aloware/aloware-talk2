    ...
    rejectionTooltipData (rejectionReason, type) {
      switch (rejectionReason) {
        ...
        case CommunicationRejectionReasons.REJECTION_REASON_KYC_CALLS_OUTBOUND_RESTRICTION:
          return 'Your trial plan does not allow to make calls to this number. Submit your business information for verification to unlock calling features to other numbers.'
      }
    },
