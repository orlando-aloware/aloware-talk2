  ...
  methods: {
    ...
    getListDataCount (data, skipCancelToken = false, isStaticList = false, listId = null, skipCache = false) {
      ...
      if (isStaticList && !this.$route.path.includes('/add') && isEmpty(tempFilters)) {
        return this.$axios.get(`https://pr-10466.mde.alodev.org/api/v2/contacts-list/${listId}/count`, {
      ...
      return this.$axios.get(`https://pr-10466.mde.alodev.org/api/v2/contacts/count`, {
        params: {
