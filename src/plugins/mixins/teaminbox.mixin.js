...
export default {
  computed: {
    ...
    companyHasAccessToAllInboxes () {
      // All Inboxes Whitelisted companies (WAT-1772)
      const ALL_INBOXES_WHITELISTED_COMPANIES = [135, 497, 1362, 1413, 1990, 2382, 2521, 3493, 4152, 5018, 5597, 6224, 6554, 7113, 1728, 1979, 6663, 7666, 7756, 7757]
