  ...
  methods: {
    ...
    isTranscriptionAllowed (communication) {
      return communication.is_eligible_for_transcribe &&
             ...
             ![TranscriptionStatus.STATUS_CREATED, TranscriptionStatus.STATUS_PROCESSING, TranscriptionStatus.STATUS_COMPLETED, TranscriptionStatus.STATUS_PARSED].includes(communication.call_transcription_status)
    },
