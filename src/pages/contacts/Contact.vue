...
export default {
  ...
  computed: {
    ...
    isInbox () {
      return ['Inbox Contact', 'Inbox Contact Task', 'Inbox', 'Inbox Contact Communication', EINBOXES_MENU_COMMUNICATIONS].includes(this.$route.name)
    },
  ...
  created () {
    ...
    this.contactComponentListeners.contactTaskStatusUpdated = (contact) => {
      ...
      const validRoutes = ['Contact', 'Inbox Contact', 'Inbox View Contact Task', 'Inbox Contact Communication', EINBOXES_MENU_COMMUNICATIONS]
  ...
  watch: {
    '$route.params.id': function (value) {
      ...
      if (['Contact', 'Inbox Contact', 'Inbox Contact Task', 'Inbox View Contact Task', 'Inbox Contact Communication', EINBOXES_MENU_COMMUNICATIONS].includes(this.$route.name) && this.contactId !== value) {
    ...
    '$route.params.communicationId': function (value) {
      if (!this.changingSelectedContact && ['Inbox Contact', 'Inbox Contact Communication', EINBOXES_MENU_COMMUNICATIONS].includes(this.$route.name)) {
