...
import SearchGiphy from 'pages/contacts/_components/message-composer/options/search-giphy'
import Attachments from 'pages/contacts/_components/message-composer/options/attachments'
