...
import SelectListTreeFolderContents
  from 'pages/contacts/_components/select-list-tree-folder/select-list-tree-folder-contents'
import SelectListTreeListContents
  from 'pages/contacts/_components/select-list-tree-folder/select-list-tree-list-contents'
