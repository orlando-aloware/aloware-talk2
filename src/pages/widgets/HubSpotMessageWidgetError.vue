  ...
  <div class="row hubspot-widget-error-details">
    <div class="col-12">
      ...
      <div v-if="errorCode === HubspotMessageError.ERROR_NO_MATCHING_ALOWARE_AND_CRM_ACCOUNT_ID">
        <p>Fix by re-authenticating the Aloware HubSpot integration from <a
            class="text-blue"
            target="_blank"
            :href="integrationSettingsUrl"
          >HubSpot Settings</a>.</p>
      </div>
      ...
      <div v-else-if="errorCode === HubspotMessageError.ERROR_CRM_INTEGRATION_DISABLED">
        <p>Fix by enabling the HubSpot integration in Aloware from <a
            class="text-blue"
            target="_blank"
            :href="integrationSettingsUrl"
          >HubSpot Settings</a>.</p>
      ...
      <div v-else-if="errorCode === HubspotMessageError.ERROR_CONTACT_FETCH_FAILED">
        ...
        <p>2. If error persists, try re-authenticating the Aloware HubSpot integration from <a
            target="_blank"
            class="text-blue"
            :href="integrationSettingsUrl"
          >HubSpot Settings</a>.</p>
